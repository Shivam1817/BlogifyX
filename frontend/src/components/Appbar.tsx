    ...
    return <div className="border-b flex justify-between px-10 py-4">
        ...
        <div>
            <Link to={`/publish`}>
                ...
                focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2">New</button>
            </Link>
            <Avatar name = {localStorage.getItem("user") || "Anonymous"} size = {"big"}/>
        </div>
    </div>
}